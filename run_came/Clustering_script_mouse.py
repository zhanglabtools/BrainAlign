...
if __name__ == "__main__":
    ...
    path_rawdata_mouse = "./brain_human_mouse/mouse_brain_region_67_sparse.h5ad"
    ...
    sc.pl.pca(adata, color='region_name', components = ['1,2','3,4','5,6','7,8'], ncols=2, return_fig=True).savefig('./figs/mouse_67/pca.png')
    ...
    sc.pl.umap(adata, color=['region_name'], return_fig=True).savefig('./figs/mouse_67/umap.png')
    ...
    adata.obs['kmeans11'] = kmeans.labels_.astype(str)
    ...
    sc.pl.umap(adata, color=['kmeans5', 'kmeans11', 'kmeans20', 'kmeans67'], return_fig=True).savefig('./figs/mouse_67/k-means.png')
    
    
    
    
    
    path_rawdata_mouse = "./brain_human_mouse_16_11/mouse_brain_region_11_sparse.h5ad"
    adata = sc.read_h5ad(path_rawdata_mouse)
    ...
    sc.tl.pca(adata, svd_solver='arpack')
    sc.pl.pca(adata, color='region_name', components = ['1,2','3,4','5,6','7,8'], ncols=2, return_fig=True).savefig('./figs/mouse_11/pca.png')
    
    
    sc.pp.neighbors(adata, n_pcs = 30, n_neighbors = 20)
    sc.tl.umap(adata)
    
    sc.pl.umap(adata, color=['region_name'], return_fig=True).savefig('./figs/mouse_11/umap.png')
    ...
    sc.pl.umap(adata, color=['kmeans5', 'kmeans11', 'kmeans20'], return_fig=True).savefig('./figs/mouse_11/k-means.png')    
