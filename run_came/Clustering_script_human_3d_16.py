...
if __name__ == "__main__":
    ...
    path_rawdata_mouse = "./brain_human_mouse_16_11/human_brain_region_16_sparse_with3d.h5ad"
    ...
    cmap = ListedColormap(sns.color_palette(n_colors=16, as_cmap=True))
    ...
    # save
    plt.savefig("./figs/human_16/scatter_xyz_region_name.png", bbox_inches='tight')
    
    
    
    
    color_list_str = list(adata.obs['kmeans16'].values)
    ...
    # save
    plt.savefig("./figs/human_16/scatter_xyz_kmeans_16.png", bbox_inches='tight')
