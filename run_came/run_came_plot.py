...
def run_came(path_rawdata1 = '../Brain_ST_human_mouse/data/mouse_brain_region_67_sagittal.h5ad',
             path_rawdata2 = './brain_human_mouse/human_brain_region_88_sparse.h5ad',
             ROOT_path = '/home1/zhangbiao/CAME/brain_mouse_human_sagittal/'):
    logging.basicConfig(
        level=logging.INFO,
    ...
    path_rawdata1 = path_rawdata1
    path_rawdata2 = path_rawdata2
