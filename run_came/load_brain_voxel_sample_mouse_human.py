...
if __name__ == '__main__':
    ...
    path_rawdata1 = './brain_human_mouse/mouse_brain_region_67_sparse.h5ad'
    ...
    came_resdir = Path("/home1/zhangbiao/CAME/brain_human_mouse/('Baron_mouse', 'Baron_human')-(06-19 10.11.04)")
