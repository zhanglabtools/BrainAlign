# -*- coding: utf-8 -*-
"""
Created on Wed May  5 20:08:52 2022
...
if __name__ == '__main__':
    ...
    path_varmap = './came/sample_data/gene_matches_mouse2human.csv'
    path_varmap_1v1 = './came/sample_data/gene_matches_1v1_mouse2human.csv'
    ...
    resdir = ROOT + f'{dsn1}-{dsn2}-{time_tag}/'  # set by user
    figdir = resdir + '/figs/'
    ...
    print('came_results:', came_inputs)

    print('Mouse features: ', came_inputs['adatas'][0])
    X = came_inputs['adatas'][0].X.toarray()
    print(type(X))
    came_inputs['adatas'][0].X = sparse.csr_matrix(threshold_quantile(X, quantile_gene=0.8, quantile_sample=0.99))

    print('Human features: ', came_inputs['adatas'][1])
    X = came_inputs['adatas'][1].X.toarray()
    print(type(X))
    came_inputs['adatas'][1].X = sparse.csr_matrix(threshold_quantile(X, quantile_gene=0.8, quantile_sample=0.99))
