...
def run_came(cfg):
    ...
    # sc.tl.leiden(adata_raw1, resolution=cfg.CAME.preclustering_resolution, key_added='cluster_region')
    # print(adata_raw1)
    ...
    # sc.tl.leiden(adata_raw2, resolution=cfg.CAME.preclustering_resolution, key_added='cluster_region')
    # print(adata_raw2)

    # adata_raw1.obs['cluster_region'] = ['s1 ' + x for x in adata_raw1.obs['cluster_region']]
    # adata_raw2.obs['cluster_region'] = ['s2 ' + x for x in adata_raw2.obs['cluster_region']]
