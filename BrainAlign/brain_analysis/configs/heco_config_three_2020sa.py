...
_C.HECO.normalize_before_pca = 'default' #'default'  # None represent no normalization
...
_C.HECO.dataset = 'mouse_human_three'
_C.HECO.mouse_dataset = '2020sa'#'2006nature' # 2020sa
_C.HECO.result_save_folder = './results_{}_{}/'.format(_C.HECO.homo_region_num, _C.HECO.mouse_dataset)
...
_C.HECO.normalize_before_pruning_method_1 = None
...
_C.HECO.S = 11389 # 21749 + 3682
_C.HECO.S_sample_rate = [1]
_C.HECO.G = 1570#4035 + 6507
_C.HECO.G_sample_rate = [5]
_C.HECO.V = 975#4035 + 6507
_C.HECO.V_sample_rate = [12]

_C.HECO.binary_S = 11389 #
_C.HECO.binary_M = 785#4035
_C.HECO.binary_H = 785#6507
_C.HECO.binary_V = 975
