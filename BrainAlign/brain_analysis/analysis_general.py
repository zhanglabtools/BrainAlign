...
class alignment_STs_analysis():
    def __init__(self, cfg):
        ...
        self.mouse_64_labels = pd.read_csv(cfg.CAME.path_labels_1)
        ...
        self.human_88_labels = pd.read_csv(cfg.CAME.path_labels_2)
        ...
        for k,v in self.mouse_64_acronym_color_dict.items():
            self.acronym_color_dict.update({k:v})
        ...
        self.species1 = self.cfg.BrainAlign.dsnames[0]
        self.species2 = self.cfg.BrainAlign.dsnames[1]
    ...
    def init_data(self):
        ...
        # read labels data including acronym, color and parent region name
        mouse_64_labels = pd.read_csv(cfg.CAME.path_labels_1)
        ...
        adata_mouse_embedding.obs['dataset'] = self.species1
        adata_human_embedding.obs['dataset'] = self.species2
        ...
        adata_mouse_embedding.obs['color_hex_triplet'] = [mouse_64_color_dict[r] for r in
                                                          adata_mouse_embedding.obs['region_name']]
        adata_mouse_embedding.obs['annotation'] = adata_mouse_embedding.obs['region_name']
        ...
        adata_human_embedding.obs['color_hex_triplet'] = [human_88_color_dict[r] for r in
                                                          adata_human_embedding.obs['region_name']]
        adata_human_embedding.obs['annotation'] = adata_human_embedding.obs['region_name']
        adata_human_embedding.write_h5ad(cfg.BrainAlign.embeddings_file_path + '/v_embeddings.h5ad')

        adata_embedding = ad.concat([adata_mouse_embedding, adata_human_embedding], axis=0)
        adata_embedding.write_h5ad(cfg.BrainAlign.embeddings_file_path + '/adata_embeddings.h5ad')
    ...
    def experiment_1_cross_species_clustering(self):
        ...
        lut = {self.species2: self.human_color, self.species1: self.mouse_color}
        print(lut)
        row_colors = []
        for i in range(adata_human_embedding.X.shape[0]):
            row_colors.append(lut[self.species2])
        ## ---------------------------------------------------------------------mouse------------------------
        for i in range(adata_human_embedding.X.shape[0]):
            row_colors.append(lut[self.species1])
        ...
        palette = {self.species1:self.mouse_color, self.species2:self.human_color}
        ...
        homo_region_list = list(human_mouse_homo_region[self.species1].values) + list(human_mouse_homo_region[self.species2].values)

        print(self.human_88_color_dict)
        print(human_mouse_homo_region)
        homo_region_color_list = [self.mouse_64_color_dict[m_r] for m_r in list(human_mouse_homo_region[self.species1].values)] + \
                                 [self.human_88_color_dict[h_r] for h_r in list(human_mouse_homo_region[self.species2].values)]
        print(homo_region_list)
        adata_mouse_embedding_temp = adata_embedding[adata_embedding.obs['dataset'].isin([self.species1])]
        adata_mouse_embedding_temp.obs['region_name'] = [x for x in adata_mouse_embedding_temp.obs['region_name']]
        adata_human_embedding_temp = adata_embedding[adata_embedding.obs['dataset'].isin([self.species2])]
        adata_human_embedding_temp.obs['region_name'] = [x for x in
        ...
        homo_region_list_temp = list([x for x in human_mouse_homo_region[self.species1].values]) \
                                + list([x for x in human_mouse_homo_region[self.species2].values])
        ...
        homo_region_color_list_mouse = sns.color_palette(cc.glasbey, n_colors=len(list([x for x in human_mouse_homo_region[self.species1].values])))
        ...
        with plt.rc_context({"figure.figsize": (18.5, 5), "figure.dpi": (self.fig_dpi)}):
            fg = sc.pl.umap(adata_embedding_homo_temp, color=['dataset'], return_fig=True,
                            legend_loc='right margin', palette={self.species1:self.mouse_color, self.species2:self.human_color}, size=20)
            plt.title('')
            fg.savefig(
        ...
        sc.tl.pca(adata_embedding, svd_solver='arpack', n_comps=20)
    ...
    def experiment_2_umap_evaluation(self):
        ...
        * 5. plot the box plots.
        ...
        umap_size_dict = {self.species1:cfg.ANALYSIS.mouse_umap_marker_size, self.species2:cfg.ANALYSIS.human_umap_marker_size}
        ...
        with plt.rc_context({"figure.figsize": (4, 2), "figure.dpi": (self.fig_dpi)}):
            sc.pl.umap(adata_mouse_embedding, color=['region_name'], return_fig=True, legend_loc='right margin').savefig(
                save_path + f'umap_{self.species1}.' + fig_format, format=fig_format)
            plt.show()
        ...
        with plt.rc_context({"figure.figsize": (4, 2), "figure.dpi": (self.fig_dpi)}):
            ...
            sc.pl.umap(adata_human_embedding, color=['region_name'], return_fig=True, size=30,
                ...
                save_path + f'umap_{self.species2}.' + fig_format, format=fig_format)
            plt.show()
        # plt.subplots_adjust(left=0.1, right=5)
        # plt.tight_layout()
        ...
        sc.tl.pca(adata_mouse_expression, svd_solver='arpack', n_comps=20)
        ...
        sc.tl.pca(adata_human_expression, svd_solver='arpack', n_comps=20)
        ...
        adata_mouse_expression.obs['dataset'] = self.species1
        adata_human_expression.obs['dataset'] = self.species2
    ...
    def homo_corr(self):
        ...
        k = 0
        human_correlation_dict = {f'{self.species2}_region_list': [], 'mean': [], 'std': []}
        mouse_correlation_dict = {f'{self.species1}_region_list': [], 'mean': [], 'std': []}
        human_mouse_correlation_dict = {f'{self.species2}_region_list': [], f'{self.species1}_region_list': [], 'mean': [], 'std': []}
        ...
        for human_region, mouse_region in home_region_dict.items():
            ...
            human_correlation_dict[f'{self.species2}_region_list'].append(human_region)
            ...
            mouse_correlation_dict[f'{self.species1}_region_list'].append(mouse_region)
            ...
            human_mouse_correlation_dict[f'{self.species2}_region_list'].append(human_region)
            human_mouse_correlation_dict[f'{self.species1}_region_list'].append(mouse_region)
    ...
    def plot_homo_random(self):
        ...
        plt.text(0.35, 0.30, f'R = {round(r_value, 3)}, P < {round(p_value, 3)}')
    ...
    def experiment_3_1_homo_random_beforeAlign(self):
        ...
        human_mouse_dict_amount = {self.species2: [], self.species1: []}
        for human_region, mouse_region in home_region_dict.items():
            ...
            human_mouse_dict_amount[self.species1].append(mouse_r_num)
            human_mouse_dict_amount[self.species2].append(human_r_num)

        #ax = plt.figure(figsize=(4, 4), dpi=self.fig_dpi)
        # with plt.rc_context({"figure.figsize": (8, 8), "figure.dpi": (self.fig_dpi)}):
        g = sns.jointplot(data=pd.DataFrame.from_dict(human_mouse_dict_amount), x=self.species2, y=self.species1,
                          kind="reg", height=4, color='black') #ax=ax, ,  marginal_kws={'color': 'black'}
        from scipy import stats
        slope, intercept, r_value, p_value, std_err = stats.linregress(np.array(human_mouse_dict_amount[self.species2]),
                                                                       np.array(human_mouse_dict_amount[self.species1]))
        #plt.text(2, 3800, 'R = 0.319, P = 0.171')  # 0.31880896646406354, P = 0.1706
        print(f'R = {r_value}, P = {p_value}')
        plt.setp(g.ax_marg_y.patches, color=self.mouse_color)
        plt.setp(g.ax_marg_x.patches, color=self.human_color)
        plt.title('')
        plt.xlabel(f'{self.species2} spot number')
        plt.ylabel(f'{self.species1} spot number')
        plt.savefig(save_path + f'Amount_{self.species1}_{self.species2}.' + self.fig_format, format=self.fig_format, dpi=self.fig_dpi)


        #ax = plt.figure(figsize=(4, 4), dpi=self.fig_dpi)
        # with plt.rc_context({"figure.figsize": (8, 8), "figure.dpi": (self.fig_dpi)}):
        g = sns.jointplot(data=pd.DataFrame.from_dict(human_mouse_dict_mean), x=self.species2, y=self.species1, kind="reg",
                      height=4, color='black') # , ax=ax
        plt.title('')

        from scipy import stats
        slope, intercept, r_value, p_value, std_err = stats.linregress(np.array(human_mouse_dict_mean[self.species2]),
                                                                       np.array(human_mouse_dict_mean[self.species1]))
    ...
    def experiment_4_cross_species_genes_analysis(self):
        ...
        adata_mouse_gene_embedding.obs['dataset'] = self.species1
        adata_human_gene_embedding.obs['dataset'] = self.species2
        ...
        adata_mouse_gene_embedding = adata_gene_embedding[adata_gene_embedding.obs['dataset'].isin([self.species1])]
        adata_human_gene_embedding = adata_gene_embedding[adata_gene_embedding.obs['dataset'].isin([self.species2])]
        ...
        adata_gene_umap_mouse = adata_gene_embedding[adata_gene_embedding.obs['dataset'] == self.species1]
        adata_gene_umap_human = adata_gene_embedding[adata_gene_embedding.obs['dataset'] == self.species2]
        ...
        homo_region_color_list = [self.mouse_64_color_dict[m_r] for m_r in
                                  list(human_mouse_homo_region[self.species1].values)] + \
                                 [self.human_88_color_dict[h_r] for h_r in
                                  list(human_mouse_homo_region[self.species2].values)]
        #print(homo_region_list)
        #adata_embedding_homo = adata_embedding[adata_embedding.obs['region_name'].isin(homo_region_list)]
        homo_region_palette = {k: v for k, v in zip(homo_region_list, homo_region_color_list)}

        mouse_homo_region_list = list(human_mouse_homo_region[self.species1].values)
        human_homo_region_list = list(human_mouse_homo_region[self.species2].values)
        ...
        adata_mouse_gene_embedding_filtered.obs['dataset'] = self.species1
        adata_human_gene_embedding_filtered.obs['dataset'] = self.species2
    ...
    def experiment_5_genes_homo_random(self):
        ...
        mouse_df = pd.DataFrame(adata_mouse_gene_embedding.X).T
        mouse_df.columns = [f'{self.species1}_' + x for x in adata_mouse_gene_embedding.obs_names]
        print(mouse_df.shape)
        human_df = pd.DataFrame(adata_human_gene_embedding.X).T
        human_df.columns = [f'{self.species2}_' + x for x in adata_human_gene_embedding.obs_names]
        print(human_df.shape)
