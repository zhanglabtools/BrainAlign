...
def load_heco_embeddings(cfg):
    ...
    print(len(datapair['varnames_node'][0]))
    np.save(cfg.BrainAlign.embeddings_file_path + f'{cfg.BrainAlign.dsnames[0]}_gene_names.npy', datapair['varnames_node'][0])
    print(len(datapair['varnames_node'][1]))
    np.save(cfg.BrainAlign.embeddings_file_path + f'{cfg.BrainAlign.dsnames[1]}_gene_names.npy', datapair['varnames_node'][1])
